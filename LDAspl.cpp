...
<<<<<<< HEAD
    ...
    vector<string> inputs = {
        ...
        "I love using this new smartphone, the performance is amazing",
        "The new software update is okay but not very impressive",
        "The lecture was boring and difficult to understand",
